...
func (s *Server) handleAccountAction(w http.ResponseWriter, r *http.Request) {
	...
	needsPassword := action == "revoke-device" || (action == "disable-device" && strings.EqualFold(value, "off"))
